...
config. BgColor 		= '#f6f279' // Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#3f3d00'
...
config. Duration		= 1500 		// Time span in ms after which the tooltip disappears; 0 for infinite duration, < 0 for delay in ms _after_ the onmouseout until the tooltip disappears
...
config. OffsetX			= 18		// Horizontal offset of left-top corner from mousepointer
